...
\draft{
	\begin{itemize}
		\item Write about the electrode labels
		\item Connect with the following subsection
	\end{itemize}
}
...
\draft{
	\begin{itemize}
		\item Write that paraview is used to vie the mesh and generate all figures
		\item Refer to VTK file usage
	\end{itemize}
}Ab
